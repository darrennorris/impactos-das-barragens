...
Aqui usamos os dados de 2020 e calcular uma metrica para cada buffer no obejeto (ada_buff_31976).
...
Isso pode demorar us minutos. Depois que executar ("run"), podemos olhar os dados com o codigo a seguir. 
